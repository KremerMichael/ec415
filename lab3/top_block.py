...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_c([1,1,0.5,1,0.5]*2000, False, 1, [])
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0.3, 0.95, 0)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, samples_per_bit)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*1, samples_per_bit)
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar()
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/ask_out.bin', False)
    ...
    def set_samples_per_bit(self, samples_per_bit):
        ...
        self.blocks_keep_one_in_n_0.set_n(self.samples_per_bit)

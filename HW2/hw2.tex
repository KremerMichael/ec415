...
\begin{enumerate}[label=\alph*.]
	\item Because the two non-zero spectrum values of a cosine wave are at +f and -f, as f increases ---TODO
	\begin{figure}[H]
		\centering
		\begin{subfigure}{.5\textwidth}
  			\centering
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.5\textwidth}
  			...
  			\label{fig:sub2}
		\end{subfigure}
		\caption{cosine of increasing frequency}
		\label{fig:test}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.5\textwidth}
  			...
  			\label{fig:sub2}
		\end{subfigure}
		\caption{cosine wave of different phases}
		\label{fig:test}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.33\textwidth}
 			...
 			\label{fig:sub3}
		\end{subfigure}
		\caption{cosine wave of increasing sampling rate}
		\label{fig:test}
	\end{figure}
\end{enumerate}
\pagebreak

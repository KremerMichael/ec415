...
\lstinputlisting[caption = {MATLAB code for Exercise 3.1}, language = Matlab]{p3_1.m}

\begin{enumerate}[label=\alph*.]

	\item As the frequency increases, the density of square waves on the time plot increases while the spectra plot is extended across the frequency axis.
	\begin{figure}[H]
		\centering
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.5\textwidth}
  			...
  			\label{fig:sub2}
		\end{subfigure}
		\caption{square waves with different frequencies}
		\label{fig:test}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.33\textwidth}
 			...
 			\label{fig:sub3}
		\end{subfigure}
		\caption{square waves of different lengths}
		\label{fig:test}
	\end{figure}
...
\begin{enumerate}[label=\alph*.]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_3a} 
		\caption{An exponential pulse \( s(t) = e^{-t} \) for \( 0 < t < 10\)}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_3b} 
		\caption{A scaled exponential pulse \( s(t) = 5e^{-t} \) for \( 0 < t < 10\)}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_3c} 
		\caption{A Gaussian pulse \( s(t) = e^{-t^2} \) for \( -2 < t < 2\)}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_3d} 
		\caption{A Gaussian pulse \( s(t) = e^{-t^2} \) for \( -20 < t < 20\)}
	\end{figure}
	
	\item Here is the MATLAB code:
	\lstinputlisting[caption = {MATLAB code for part e}, language = Matlab]{p3_3e.m} 
	The resulting plots are shown in the figures below.
	\begin{figure}[H]
		\centering
		\begin{subfigure}{.33\textwidth}
  			\centering
 			\includegraphics[width=.9\textwidth]{p3_3e20}
  			\caption{f=20Hz and $\phi$=0}
  			\label{fig:sub1}
		\end{subfigure}%
		\begin{subfigure}{.33\textwidth}
  			\centering
  			\includegraphics[width=.9\textwidth]{p3_3e100}
  			\caption{f=100Hz and $\phi$=$\pi$/4}
  			\label{fig:sub2}
		\end{subfigure}%
		\begin{subfigure}{.33\textwidth}
  			\centering
 			\includegraphics[width=.9\textwidth]{p3_3e1000}
  			\caption{f=1000Hz and $\phi$=$\pi$/2}
 			\label{fig:sub3}
		\end{subfigure}
		\caption{The sinusoids \( s(t) = sin(2\pi ft + \phi )\)}
		\label{fig:test}
	\end{figure}
...
\lstinputlisting[caption = {MATLAB code for Exercise 3.6}, language = Matlab]{p3_6.m}

\begin{enumerate}[label=\alph*.]
	\item Because the two non-zero spectrum values of a cosine wave are at +f and -f, as f changes, the two spectra peaks located at +f and -f  change with it.
	\begin{figure}[H]
		\centering
		\begin{subfigure}{.5\textwidth}
  			\centering
	...
	\item As the phase changes, the plot in the time domain translates left and right accordingly, but the spectrum plot does not change.
	\begin{figure}[H]
		\centering
		\begin{subfigure}{.5\textwidth}
  			\centering
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.5\textwidth}
  			...
  			\label{fig:sub2}
		\end{subfigure}
		\caption{different phases}
		\label{fig:test}
	\end{figure}
	
	\item As you can see in the figures below, the sampling rate is important for plotting the spectrum of cosine. In the case of $T_s$=1/10 which is equal to 1/f, we mistakenly get a single peak spectrum plot. In the third image, there are two distinct peaks with sufficient zooming, but MATLAB was not cooperating on this one.
	\begin{figure}[H]
		\centering
		\begin{subfigure}{.33\textwidth}
  			\centering
...
\begin{enumerate}[label=\alph*.]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_9b} 
		\caption{Passes all frequencies below 3000 Hz}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_9c} 
		\caption{Rejects all frequencies between 1500 and 2500 Hz}
	\end{figure}
\end{enumerate}
\pagebreak
...
\begin{enumerate}[label=\alph*.]
	\item Using this filter:
	\lstinputlisting[caption = {MATLAB code for Exercise 3.10a}, language = Matlab]{p3_10a.m}
	I was able to create this output.
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_10a} 
		\caption{Passes all frequencies above 500 Hz}
	\end{figure}
		
	\item Using this filter:
	\lstinputlisting[caption = {MATLAB code for Exercise 3.10b}, language = Matlab]{p3_10b.m}
	I was able to create this output.
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_10b} 
		\caption{Passes all frequencies below 3000 Hz}
	\end{figure}
	
	\item Using this filter:
	\lstinputlisting[caption = {MATLAB code for Exercise 3.10c}, language = Matlab]{p3_10c.m}
	I was able to create this output.
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_10c} 
		\caption{Rejects all frequencies between 1500 and 2500 Hz}
	\end{figure}
\end{enumerate}
\pagebreak
...
and looking at this generated spectrum plot:
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_11} 
		\caption{}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_11norm} 
		\caption{original filternoise.m output with noisy input}
	\end{figure}
\pagebreak
...
\begin{enumerate}[label=\alph*.]
	\item Using this MATLAB script:
	\lstinputlisting[caption = {MATLAB code for Exercise 3.26a}, language = Matlab]{p3_26a.m}
	I was able to create this output.
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_26a} 
		\caption{The input is \(x(t) = cos(2*\pi*f_1*t) + cos(2*\pi*f_2*t)\) for $f_1$ = 100 and $f_2$ = 150 Hz}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_26b} 
		\caption{The input is a square wave with fundamental f = 150 Hz}
	\end{figure}
	
	\item Using this MATLAB script:
	\lstinputlisting[caption = {MATLAB code for Exercise 3.26c}, language = Matlab]{p3_26c.m}
	I was able to create this output.
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{p3_26c} 
		\caption{The input is a noise signal with all energy below 300 Hz}
	\end{figure}
\end{enumerate}
\pagebreak

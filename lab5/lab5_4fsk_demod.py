...
class lab5_4fsk_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_float_to_char_0, 0), (self.blocks_keep_one_in_n_0, 0))
    ...
    def set_fsk_deviation_hz(self, fsk_deviation_hz):
        ...
        self.set_filter_cutoff(3.5*self.fsk_deviation_hz)
...
def main(top_block_cls=lab5_4fsk_demod, options=None):

...
class lab5_gfsk_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_gfsk_demod")
        ...
        self.filter_cutoff = filter_cutoff = 0.95*fsk_deviation_hz
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/ad/eng/users/k/r/kremerme/Desktop/ec415/lab5/lab5_gfsk(1).iq', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/ad/eng/users/k/r/kremerme/Desktop/ec415/lab5/gfsk_out.bin', False)
    ...
    def set_fsk_deviation_hz(self, fsk_deviation_hz):
        ...
        self.set_filter_cutoff(0.95*self.fsk_deviation_hz)
...
def main(top_block_cls=lab5_gfsk_demod, options=None):

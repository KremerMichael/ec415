% Based on AM.m suppressed carrier AM with freq and phase offset
time=10; Ts=1/10000;               % sampling interval & time
...
gam=0.1; phi=0;                       % freq & phase offset
...
figure(1),plotspec(w,Ts),title('spectrum of sent message');
figure(2),plotspec(m,Ts),title('spectrum of received message')
...
%axis([0,0.1, -1,3])
%ylabel('amplitude');
%title('(c) demodulated signal (before LPF)');
